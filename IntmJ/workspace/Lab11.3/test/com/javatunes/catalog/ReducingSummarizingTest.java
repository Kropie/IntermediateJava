...
//TODONE: Uncomment the static imports that we supply as you need them
...
public class ReducingSummarizingTest {
    ...
    public void testAveragePriceMusicCategory() {
        // TODONE
        Map<MusicCategory, Double> map = allMusicItems.stream()
                .collect(groupingBy(o -> o.getMusicCategory(), mapping(MusicItem::getPrice, averagingDouble(value -> value))));
        System.out.println("------- Average Price for each MusicCategory -------");
     ...
     * Other  all others.
     * Hint: Decide should your test be to see if the item is in one of the two categories above, then use it to
     * partition
     * <p>
    ...
    /**
     * CHALLENGE: what is our most popular "release year," i.e., we have more items released in that year than any
     * other.
