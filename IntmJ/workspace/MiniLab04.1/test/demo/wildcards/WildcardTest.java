...
public class WildcardTest {
  ...
  public void testSumNumber() {
    ...
    numbers.add(new Integer(7));    // not autoboxing here just for emphasis
    numbers.add(new Double(3.14));  // numbers has subtypes in it
    numbers.add(new Long(12));      // inheritance 101 (IS-A)
